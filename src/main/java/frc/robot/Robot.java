...
public class Robot extends TimedRobot {
  ...
  private void updateDashboard() {
    ...
    /*updateDashboard is used as a common location to place items that are put on the dashboard
    This simplifies the code as dashboard update items are placed in one location and not
    scattered all over 
    */
